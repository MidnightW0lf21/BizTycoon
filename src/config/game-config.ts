...
export const INITIAL_GARAGE_CAPACITY = 2;
export const MAX_GARAGE_CAPACITY = 12;
export const GARAGE_UPGRADE_COST_BASE = 100000000; // 100M
export const GARAGE_UPGRADE_COST_MULTIPLIER = 2.5;
...
export const DRIVER_BASE_ENERGY = 10800; // 3 hours
