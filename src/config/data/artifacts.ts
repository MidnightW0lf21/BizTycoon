...
import { Gem, Compass, BookOpen, Scaling, PiggyBank, Factory as FactoryIcon, Mountain, Pickaxe, Cog, FlaskConical, Building, Calculator, TrendingUp, HeartPulse, Hand, Crown, Scroll, Wrench, Wheat, InfinityIcon as Infinity, Clock, Diamond, Feather, DraftingCompass, Sigma, Dices, Hammer, Archive, Map, Eye, ShoppingBag, Sprout, PenTool, HandCoins, Coins, Castle, KeyRound, Brain, Telescope, Pyramid, Gavel, Recycle, Trees, Unplug, PersonStanding, MountainSnow, Combine, Hourglass, Bot, HardHat, Coffee, Award, Handshake, BoxIcon, Plane, Speaker, Binary, GitMerge as GitMergeIcon, Drama, Target, Shield, Sun, Wind, Route, Bone, Globe, Milestone, Scale, Cookie, ShieldCheck, ShieldAlert, Music, Mouse, Keyboard, StickyNote, Footprints, FileText, Droplets, Shirt, GlassWater, Contact, Server, Ship, ShoppingBasket, Lightbulb, Fan, Pen, Sparkles, Citrus, Dna, Flame, MessageSquare, Zap, BatteryCharging, Briefcase } from 'lucide-react';
...
export const INITIAL_ARTIFACTS: Artifact[] = [
  ...
  {
    id: 'ceos_first_business_card_common',
  ...
  {
    id: 'investors_lucky_tie_clip_common',
  ...
  {
    id: 'robust_server_rack_casing_common',
  ...
  {
    id: 'high_efficiency_led_lightbulb_common',
  ...
  {
    id: 'programmers_rubber_duck_of_clarity_common',
  ...
  },
  {
    ...
    description: 'A remarkably taught and resilient string. Boosts all Aerospace businesses income by 1%.',
    icon: Target,
    rarity: 'Common',
    effects: { }
  },
  ...
  },
  {
    id: 'dusty_old_map',
    name: 'Dusty Old Map',
    description: 'A map that seems to lead to forgotten savings. Increases starting cash by $1,200.',
    icon: Map,
    rarity: 'Common',
    effects: { increaseStartingMoney: 1200 },
  },
  {
    id: 'motivational_mousepad',
    name: 'Motivational Mousepad',
    description: 'Inscribed with "Think Like a Tycoon". Global income +0.15%.',
    icon: Mouse,
    rarity: 'Common',
    effects: { globalIncomeBoostPercent: 0.15 },
  },
  {
    id: 'ergonomic_keyboard',
    name: 'Ergonomic Keyboard',
    description: 'Reduces strain, making operations slightly cheaper. Reduces global business level-up costs by 0.15%.',
    icon: Keyboard,
    rarity: 'Common',
    effects: { globalCostReductionPercent: 0.15 },
  },
  {
    id: 'slightly_sticky_note',
    name: 'Slightly-Sticky Note',
  ...
  },
  {
    ...
    description: 'Calming to hold. Increases Quarry Dig Power by 1.',
    icon: Gem,
    rarity: 'Common',
    effects: { quarryDigPower: 1 },
  },
  {
    id: 'hardy_work_boots',
    name: 'Hardy Work Boots',
    description: 'Extra tough boots for long days. Increases maximum Quarry Energy by 2.',
    icon: Footprints,
    rarity: 'Common',
    effects: { increaseMaxEnergy: 2 },
  },
  {
    id: 'blueprint_scrap',
    name: 'Blueprint Scrap',
    description: 'A torn piece of a blueprint with a cost-saving annotation. Reduces global business upgrade costs by 0.2%.',
    icon: FileText,
    rarity: 'Common',
    effects: { globalBusinessUpgradeCostReductionPercent: 0.2 },
  },
  {
    id: 'leaky_oil_can',
    name: 'Leaky Oil Can',
  ...
  },
  {
    ...
    name: 'Faded Company T-Shirt',
    description: 'A relic from a past company picnic. Instills a sense of nostalgia and boosts global income by 0.1%.',
    icon: Shirt,
    rarity: 'Common',
    effects: { globalIncomeBoostPercent: 0.1 },
  },
  {
    id: 'cracked_safety_goggles',
    name: 'Cracked Safety Goggles',
    description: 'They\'ve seen better days, but they\'re better than nothing. Increases maximum Quarry Energy by 1.',
    icon: GlassWater,
    rarity: 'Common',
  ...
  },
  {
    ...
    description: 'A slightly chipped mug. Makes you feel important. +0.3% global income.',
    icon: Coffee,
    rarity: 'Common',
    effects: { globalIncomeBoostPercent: 0.3 },
  },
  {
    id: 'lucky_cat_figurine',
    name: 'Lucky Cat Figurine',
    description: 'A small, waving cat figurine. Beckons wealth. +0.4% global income.',
    icon: Hand,
    rarity: 'Common',
    effects: { globalIncomeBoostPercent: 0.4 },
  },
