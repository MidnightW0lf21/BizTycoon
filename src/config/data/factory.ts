...
export const INITIAL_FACTORY_COMPONENTS_CONFIG: FactoryComponent[] = [
  ...
  // Family: Advanced Sensors
  {
    ...
    requiredAssemblerMark: 1,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'renewable_energy_corp', percent: 0.025 }, maxBonusPercent: 2 }
  },
  {
    ...
    productionTimeSeconds: 75,
    requiredAssemblerMark: 2,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'planetary_terraforming_corp', percent: 0.05 }, maxBonusPercent: 3 }
  },
  {
    ...
    productionTimeSeconds: 310,
    requiredAssemblerMark: 3,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'interstellar_trading_guild', percent: 0.07 }, maxBonusPercent: 4 }
  },
  ...
  // Family: Communication Systems
  {
    ...
    requiredAssemblerMark: 1,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'drone_delivery_service', percent: 0.03 }, maxBonusPercent: 2.2 }
  },
  {
    ...
    productionTimeSeconds: 90,
    requiredAssemblerMark: 2,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'global_satellite_network', percent: 0.06 }, maxBonusPercent: 3.5 }
  },
  {
    ...
    productionTimeSeconds: 350,
    requiredAssemblerMark: 3,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'universal_consciousness_network', percent: 0.08 }, maxBonusPercent: 5 }
  },
  ...
  // Family: Robotics AI Cores
  {
    ...
    requiredAssemblerMark: 1,
    effects: { businessSpecificLevelUpCostReductionPercent: { businessId: 'robotics_factory_synthodynamics', percent: 0.02 }, maxBonusPercent: 1 }
  },
  {
    ...
    requiredAssemblerMark: 2,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'autonomous_megafactories', percent: 0.04 }, maxBonusPercent: 2.8 }
  },
  {
    ...
    productionTimeSeconds: 300,
    requiredAssemblerMark: 3,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'sentient_ai_consultancy', percent: 0.06 }, maxBonusPercent: 3.8 }
  },
  ...
  // Specific Business Boosts (Phase 4 Additions)
  {
    ...
    productionTimeSeconds: 330,
    requiredAssemblerMark: 3,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'luxury_space_tourism', percent: 0.09 }, maxBonusPercent: 5 }
  },
  {
    ...
    requiredAssemblerMark: 4,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'ai_driven_healthcare', percent: 0.1 }, maxBonusPercent: 6 }
  },
  {
    ...
    productionTimeSeconds: 1000,
    requiredAssemblerMark: 4,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'advanced_materials_rd', percent: 0.11 }, maxBonusPercent: 6.5 }
  },
  {
    ...
    productionTimeSeconds: 920,
    requiredAssemblerMark: 4,
    effects: { businessSpecificLevelUpCostReductionPercent: { businessId: 'fusion_power_plant', percent: 0.05 }, maxBonusPercent: 3 }
  },
  {
    ...
    productionTimeSeconds: 340,
    requiredAssemblerMark: 3,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'interstellar_trading_guild', percent: 0.08 }, maxBonusPercent: 4.5 }
  },
  {
    ...
    requiredAssemblerMark: 5,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'neural_interface_tech', percent: 0.13 }, maxBonusPercent: 7 }
  },
  {
    ...
    requiredAssemblerMark: 4,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'oceanic_colonization_project', percent: 0.1 }, maxBonusPercent: 5.5 }
  },
  {
    ...
    requiredAssemblerMark: 5,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'dyson_sphere_engineering', percent: 0.14 }, maxBonusPercent: 7.2 }
  },
  {
    ...
    requiredAssemblerMark: 5,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'galactic_stock_exchange', percent: 0.12 }, maxBonusPercent: 6.8 }
  },
  {
    ...
    productionTimeSeconds: 1150,
    requiredAssemblerMark: 4,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'universal_translation_services', percent: 0.11 }, maxBonusPercent: 6.2 }
  },
  {
    ...
    requiredAssemblerMark: 5,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'exotic_matter_research', percent: 0.15 }, maxBonusPercent: 7.8 }
  },
  {
    ...
    productionTimeSeconds: 1200,
    requiredAssemblerMark: 4,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'hyperspace_travel_agency', percent: 0.1 }, maxBonusPercent: 5.8 }
  },
  {
    ...
    requiredAssemblerMark: 5,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'custom_genome_design', percent: 0.14 }, maxBonusPercent: 7.1 }
  },
  {
    ...
    productionTimeSeconds: 900,
    requiredAssemblerMark: 4,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'galactic_archaeology_guild', percent: 0.12 }, maxBonusPercent: 6 }
  },
  {
    ...
    productionTimeSeconds: 4000,
    requiredAssemblerMark: 5,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'zero_point_energy_solutions', percent: 0.16 }, maxBonusPercent: 8 }
  },
  {
    ...
    productionTimeSeconds: 3800,
    requiredAssemblerMark: 5,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'universal_consciousness_network', percent: 0.13 }, maxBonusPercent: 6.5 }
  },
  {
    ...
    productionTimeSeconds: 4200,
    requiredAssemblerMark: 5,
    effects: { businessSpecificIncomeBoostPercent: { businessId: 'ascension_technologies', percent: 0.14 }, maxBonusPercent: 7 }
  },
  ...
  // Business Type Boosts (Phase 4 Additions)
  {
    ...
    productionTimeSeconds: 1100,
    requiredAssemblerMark: 4,
    effects: { businessTypeIncomeBoostPercent: { businessType: 'MANUFACTURING', percent: 0.02 }, maxBonusPercent: 5.5 }
  },
  {
    ...
    productionTimeSeconds: 1000,
    requiredAssemblerMark: 4,
    effects: { businessTypeIncomeBoostPercent: { businessType: 'BIO_TECH', percent: 0.022 }, maxBonusPercent: 6 }
  },
  ...
  },
  {
    ...
    productionTimeSeconds: 1300,
    requiredAssemblerMark: 4,
    effects: { factoryGlobalPowerOutputBoostPercent: 0.07, maxBonusPercent: 9 }
  },
  {
  ...
  },
  {
    ...
    icon: Library,
    tier: 5,
    recipe: [{ componentId: 'akashic_record_inc_data_compression_singularity', quantity: 1 }, { componentId: 'holographic_data_crystal', quantity: 2 }],
    rawMaterialCost: 850,
    productionTimeSeconds: 5100,
    requiredAssemblerMark: 5,
